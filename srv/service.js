module.exports = async srv => {
  ...
  messaging.on(["refappscf/ecc/123/BO/BusinessPartner/Created", "refappscf/ecc/123/ce/sap/s4/beh/businesspartner/v1/BusinessPartner/Created/v1",
  "refappscf/ecc/123/ce/BO/BusinessPartner/Created"], async msg => {
  ...
  messaging.on(["refappscf/ecc/123/BO/BusinessPartner/Changed","refappscf/ecc/123/ce/sap/s4/beh/businesspartner/v1/BusinessPartner/Changed/v1",
  "refappscf/ecc/123/ce/BO/BusinessPartner/Changed"], async msg => {
    let BUSINESSPARTNER = "";
